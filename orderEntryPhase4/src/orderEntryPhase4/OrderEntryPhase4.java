//Jordan Brown CIS 406, Course Project Phase 3
...
public class OrderEntryPhase4 {
	...
	public static void main(String[] args) {
        ...
        // ------------------- Table Header -------------------
        String headerFormat = "%-12s %-25s %10s %5s %12s %7s %12s %12s %7s %12s %12s%n";
        invoice += String.format(headerFormat,
                "Item Number", "Description", "Price", "Qty", "Gross Amt",
                "Tax %", "Tax Amt", "Gross+Tax", "Disc %", "Disc Amt", "Net Amt");
